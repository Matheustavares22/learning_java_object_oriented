...
public class TesteDesenpenhoArrayListLinkedList {
    ...
    public static void main(String[] args) {
        ...
        long quantidadeElementos = 19000000L;
    ...
    private static long insereElementosNo(List<Integer> numeros, long quantidade) {
        long ini = System.currentTimeMillis();
