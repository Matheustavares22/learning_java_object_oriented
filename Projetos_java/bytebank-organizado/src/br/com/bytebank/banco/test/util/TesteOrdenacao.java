...
//        Collections.sort(lista, new NumeroContaComparator());// Ordenação legado
//        Collections.reverse(lista);// Ordenação legado
        Collections.sort(lista);//usa a ordem narutal, esta se baseia no método compare dentro da classe mãe, no caso CONTA        
...
// --------------------------------------------------------------------------------------------------
        ...
        //Collections.sort(lista, new TitularContaComparator());// Ordenação legado
        //Collections.reverse(lista);// Ordenação legado
